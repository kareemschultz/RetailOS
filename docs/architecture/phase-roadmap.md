...
| 2 — Products & Inventory Ledger | products/variants/SKU/barcode, stock ledger, multi-UoM, serial/batch/expiry | **🔒 FROZEN** — merged to master (PR #4, `d39428d`); schema + seams + close-out complete and CI-green. Further inventory **schema** work is a change request, not in-scope. Behavior pass = `phase-2-behavior`. |
