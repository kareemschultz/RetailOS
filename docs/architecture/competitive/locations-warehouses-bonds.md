...
1. **Multi-location + typed locations + a bin hierarchy + inter-location transfers are table-stakes** — every surveyed product has them; RetailOS must reach P0 parity here.
