...
- **Phase 2 (Inventory) in progress** on branch `phase-2-implementation` — plan approved; D1–D7 locked (ADR-0007 + `module-specs/inventory.md`); **Commit 0 (RLS coverage gate) landed**; schema next. Docs: `phase-2-implementation-plan.md`, `event-map-phase2.md`, `inventory-screen-map.md`.
