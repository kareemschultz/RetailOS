  ...
  categories: [
    {
      ...
      title: "General Usage",
      description:
        "Core questions about navigating and managing your admin dashboard workspace.",
      icon: "general",
      questions: [
        {
    ...
    },
    {
      ...
      title: "Billing & Plans",
      description:
        "Answers related to subscriptions, invoices, usage limits, and plan upgrades.",
      icon: "billing",
      questions: [
        {
    ...
    },
    {
      ...
      description:
        "Get help with technical issues, incidents, and best-practice onboarding.",
      icon: "support",
      questions: [
        {
