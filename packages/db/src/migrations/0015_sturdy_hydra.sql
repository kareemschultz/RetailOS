...
CREATE TABLE "bond_receipt_line" (
	...
	CONSTRAINT "bond_receipt_line_cost_nonneg_chk" CHECK ("bond_receipt_line"."unit_cost_minor" >= 0),
...
ALTER TABLE "bond_receipt" ADD CONSTRAINT "bond_receipt_location_composite_fk" FOREIGN KEY ("tenant_id","location_id") REFERENCES "public"."location"("tenant_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "bond_receipt_line" ADD CONSTRAINT "bond_receipt_line_lot_fk" FOREIGN KEY ("lot_id") REFERENCES "public"."lot"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
