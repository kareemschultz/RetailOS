...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: canonical shadcn sidebar persistence; a single same-site state cookie, not the Cookie Store API's use case.
