...
// Dropped in from the AdminCN template (Assembly Law) — cmdk command palette,
// owned + RetailOS-formatted. One edit vs source: CommandInput uses a plain
// styled input wrapper instead of AdminCN's `input-group` primitive (which we
// don't carry), keeping the same look without the extra dependency.
